...
public class Query {
    ...
    public static final String EDGE_UPDATE = "UPDATE edge_gw_info SET manager_id = ?, start_date = ?, end_date = ?, update_date = ? WHERE id = ?";
    ...
    public static final String COMPANY_SELECT_DETAIL_BUSNIESS = "SELECT * FROM company_info where company_info.business_number = ?";

    public static final String USER_SELECT_DETAIL_BUSNIESS = "SELECT * FROM user_info where user_info.business_number = ?";

    public static final String USER_SELECT_DETAIL_ID = "select * from user_info where id= ?";
}
