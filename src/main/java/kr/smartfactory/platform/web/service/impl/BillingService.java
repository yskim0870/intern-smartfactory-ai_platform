...
public class BillingService implements IBillingService {
	...
	/**
	 * @see kr.smartfactory.platform.web.service.IBillingService#selectBilling(long, long, java.lang.String, java.lang.String, int, int, int, int, int, java.lang.String, boolean)
	 */
